...
dataset = prepareInput('./daten/FTSE_lerndaten.csv')
dataset_predict = prepareInput('./daten/FTSE_to_be_predicted.csv')
...
plt.plot(real_stock_price_close, color = 'red', label = 'Real FTSE Stock Price')
plt.plot(predicted_stock_price_close, color = 'blue', label = 'Predicted FTSE Stock Close Price')
plt.grid(b=None, which='major', axis='both')
plt.title('FTSE Stock Close Price Prediction')
plt.legend()
plt.show()