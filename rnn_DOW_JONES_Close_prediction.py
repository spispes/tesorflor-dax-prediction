...
plt.plot(real_stock_price_close, color = 'red', label = 'Real DOW JONES Stock Price')
plt.plot(predicted_stock_price_close, color = 'blue', label = 'Predicted DOW JONES Stock Close Price')
plt.grid(b=None, which='major', axis='both')
plt.title('DOW JONES Stock Close Price Prediction')
plt.legend()
plt.show()
